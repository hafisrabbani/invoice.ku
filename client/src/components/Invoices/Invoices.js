...
const Invoices = () => {
    ...
    if (rows.length === 0) {
        return <div style={{
            ...
            <NoData/>
            <p style={{padding: '40px', color: 'gray', textAlign: 'center'}}>No invoice yet. Click the plus icon to
                create invoice</p>
    ...
    return (
        <div>
            <Container style={{width: '85%', paddingTop: '70px', paddingBottom: '50px', border: 'none'}}>
              <h1 style={{textAlign: 'center', marginBottom: '20px', color: '#1976d2'}}>List of Invoices</h1>
